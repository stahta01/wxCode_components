...
-- Project name
package.name = "wxDemoViewer"
local targetName = "wxDemoViewerApp"
...
--******* WINDOWS SETUP ***********
	...
	if ( target == "cb-gcc" ) then table.insert( package.includepaths, { "$(#WX.include)", "$(#WX/contrib/include" } )
  else table.insert( package.includepaths, { "$(WXWIN)/include", "$(WXWIN)/contrib/include" } ) end
	...
	if ( options["unicode"] ) then
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver.."u_stc", "wxmsw"..wx_ver.."u" } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."ud_stc", "wxmsw"..wx_ver.."ud" } )
	else
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver.."_stc", "wxmsw"..wx_ver } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."d_stc", "wxmsw"..wx_ver.."d" } )
	end
...
--******* LINUX/MAC SETUP *************
  ...
  if ( options["unicode"] ) then wx_config_params = wx_config_params.."yes"
	...
	table.insert( package.config["Debug"].linkoptions, wx_config_params.." --debug=yes --libs std,stc`" )
	table.insert( package.config["Release"].linkoptions, wx_config_params.." --debug=no --libs std,stc`" )
end
