...
if /home/michal/Src/Projekty/wxWidgets-trunk/build-release/wx-config --unicode >/dev/null 2>/dev/null; then
	unicode="--unicode"
fi
if ! /home/michal/Src/Projekty/wxWidgets-trunk/build-release/wx-config --debug >/dev/null 2>/dev/null; then
	debug="--disable-wx-debug"
fi
release=`/home/michal/Src/Projekty/wxWidgets-trunk/build-release/wx-config --release`
