...
"..\samples\simple\v2.0.3\webupdatedlg.xrc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "$(InputPath)" "..\samples\simple\v2.0.3"
...
"..\samples\simple\v2.0.3\webupdater.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "$(InputPath)" "..\samples\simple\v2.0.3"
