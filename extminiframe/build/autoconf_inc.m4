dnl ### begin block 00_header[wxextminiframe.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[wxextminiframe.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[wxextminiframe.bkl] ###
    COND_DEPS_TRACKING_1="#"
    if test "x$DEPS_TRACKING" = "x1" ; then
        COND_DEPS_TRACKING_1=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_1)
dnl ### begin block 20_COND_PLATFORM_MACOSX_0_USE_SOVERCYGWIN_0_USE_SOVERSION_1[wxextminiframe.bkl] ###
...
dnl ### begin block 20_COND_USE_SOVERLINUX_1[wxextminiframe.bkl] ###
    COND_USE_SOVERLINUX_1="#"
    if test "x$USE_SOVERLINUX" = "x1" ; then
        COND_USE_SOVERLINUX_1=""
    fi
    AC_SUBST(COND_USE_SOVERLINUX_1)
dnl ### begin block 20_COND_USE_SOVERSION_0[wxextminiframe.bkl] ###
    COND_USE_SOVERSION_0="#"
    if test "x$USE_SOVERSION" = "x0" ; then
        COND_USE_SOVERSION_0=""
    fi
    AC_SUBST(COND_USE_SOVERSION_0)
dnl ### begin block 20_COND_USE_SOVERSOLARIS_1[wxextminiframe.bkl] ###
    COND_USE_SOVERSOLARIS_1="#"
    if test "x$USE_SOVERSOLARIS" = "x1" ; then
        COND_USE_SOVERSOLARIS_1=""
    fi
    AC_SUBST(COND_USE_SOVERSOLARIS_1)
dnl ### begin block 20_COND_WINDOWS_IMPLIB_1[wxextminiframe.bkl] ###
...
dnl ### begin block 20_COND_WX_PORT_msw[wxextminiframe.bkl] ###
    COND_WX_PORT_msw="#"
    if test "x$WX_PORT" = "xmsw" ; then
        COND_WX_PORT_msw=""
    fi
    AC_SUBST(COND_WX_PORT_msw)
dnl ### begin block 20_COND_WX_PORT_x11[wxextminiframe.bkl] ###
    COND_WX_PORT_x11="#"
    if test "x$WX_PORT" = "xx11" ; then
        COND_WX_PORT_x11=""
    fi
    AC_SUBST(COND_WX_PORT_x11)
dnl ### begin block 20_COND_WX_SHARED_0[wxextminiframe.bkl] ###
    COND_WX_SHARED_0="#"
    if test "x$WX_SHARED" = "x0" ; then
        COND_WX_SHARED_0=""
    fi
    AC_SUBST(COND_WX_SHARED_0)
dnl ### begin block 20_COND_WX_SHARED_1[wxextminiframe.bkl] ###
    COND_WX_SHARED_1="#"
