...
class WXDLLIMPEXP_SMTP wxSMTPListener
{
   public:
      ...
      //
      virtual void OnRecipientStatus(const wxString& WXUNUSED(address),
                                     wxEmailMessage::disposition WXUNUSED(disp))
      {}
      ...
      //
      virtual void OnMessageStatus(wxEmailMessage::disposition WXUNUSED(disp),
                                   bool& WXUNUSED(halt))
      {}
};
...
class WXDLLIMPEXP_SMTP wxSMTP;
class WXDLLIMPEXP_SMTP MailState;
class WXDLLIMPEXP_SMTP RetryState;

class WXDLLIMPEXP_SMTP wxSMTPTimer : public wxTimer
{
   public:
...
class WXDLLIMPEXP_SMTP wxSMTP : public wxCmdlineProtocol //, public wxEvtHandler
{
   public:
      ...
      void SetRetry(double start_seconds,
                    double multiplier,
                    double max_time)
      {
      ...
      */
      ...
      void SendFrom()
      {
         Write("MAIL FROM:<" + m_pMessage->GetFrom() + ">\x00d\x00a");
      }
