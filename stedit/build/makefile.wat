...
WXSTEDIT_CXXFLAGS = $(____WX_SHARED) $(__WXUNICODE_DEFINE_p) &
	...
	$(CXXFLAGS)
WXSTEDIT_OBJECTS =  &
	watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxstedit_app.obj &
	watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxstedit_cmdline.obj &
...
watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxstedit_app.obj :  .AUTODEPEND ..\samples\stedit\app.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXSTEDIT_CXXFLAGS) $<

watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxstedit_cmdline.obj :  .AUTODEPEND ..\samples\stedit\cmdline.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXSTEDIT_CXXFLAGS) $<
