...
!endif
__wxresizeablecontrol_lib___depname =
!ifeq WX_SHARED 0
__wxresizeablecontrol_lib___depname = &
	..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib
!endif
__wxresizeablecontrol_dll___depname =
!ifeq WX_SHARED 1
__wxresizeablecontrol_dll___depname = &
	..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).dll
!endif
__WARNINGS =
!ifeq WX_DEBUG 0
__WARNINGS = 
...
WXRESIZEABLECONTROL_LIB_OBJECTS =  &
	...
	watcom\wxresizeablecontrol_lib_textspan.obj
...
MINIMAL_OBJECTS =  &
	...
	watcom\minimal_ownerrnd.obj &
	watcom\minimal_resizecd.obj &
	watcom\minimal_childwnd.obj
...
all : .SYMBOLIC $(__wxresizeablecontrol_lib___depname) $(__wxresizeablecontrol_dll___depname) ..\samples\minimal.exe
...
clean : .SYMBOLIC 
	...
	-if exist ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib del ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib
	-if exist ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).dll del ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).dll
	-if exist ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib del ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib
	-if exist ..\samples\minimal.exe del ..\samples\minimal.exe

tarball :  
	-cd ..
	-tar -cvzf ..\wxresizeablecontrol.tar.gz --exclude=*.pdb --exclude=*.log --exclude=*.o* *

zip :  
	-cd ..
	-zip -r9 ..\wxresizeablecontrol.zip *  -x *.pdb -x *.log -x *.o*
...
..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib :  $(WXRESIZEABLECONTROL_LIB_OBJECTS)
	...
	@for %i in ($(WXRESIZEABLECONTROL_LIB_OBJECTS)) do @%append watcom\wxresizeablecontrol_lib.lbc +%i
	wlib -q -p4096 -n -b $^@ @watcom\wxresizeablecontrol_lib.lbc
!endif

!ifeq WX_SHARED 1
..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).dll :  $(WXRESIZEABLECONTROL_DLL_OBJECTS)
	@%create watcom\wxresizeablecontrol_dll.lbc
	...
	wlib -q -n -b ..\lib\wxresizeablecontrol$(WXLIBPOSTFIX).lib +$^@
!endif

..\samples\minimal.exe :  $(MINIMAL_OBJECTS) $(__wxresizeablecontrol_lib___depname) watcom\minimal_resizecd.res
...
watcom\wxresizeablecontrol_lib_resizec.obj :  .AUTODEPEND .\..\src\resizec.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_LIB_CXXFLAGS) $<

watcom\wxresizeablecontrol_lib_textbox.obj :  .AUTODEPEND .\..\src\textbox.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_LIB_CXXFLAGS) $<

watcom\wxresizeablecontrol_lib_textspan.obj :  .AUTODEPEND .\..\src\textspan.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_LIB_CXXFLAGS) $<

watcom\wxresizeablecontrol_dll_resizec.obj :  .AUTODEPEND .\..\src\resizec.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_DLL_CXXFLAGS) $<

watcom\wxresizeablecontrol_dll_textbox.obj :  .AUTODEPEND .\..\src\textbox.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_DLL_CXXFLAGS) $<

watcom\wxresizeablecontrol_dll_textspan.obj :  .AUTODEPEND .\..\src\textspan.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXRESIZEABLECONTROL_DLL_CXXFLAGS) $<

watcom\minimal_myframe.obj :  .AUTODEPEND .\..\samples\myframe.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MINIMAL_CXXFLAGS) $<

watcom\minimal_ownerrnd.obj :  .AUTODEPEND .\..\samples\ownerrnd.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MINIMAL_CXXFLAGS) $<

watcom\minimal_resizecd.obj :  .AUTODEPEND .\..\samples\resizecd.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MINIMAL_CXXFLAGS) $<

watcom\minimal_childwnd.obj :  .AUTODEPEND .\..\samples\childwnd.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(MINIMAL_CXXFLAGS) $<
