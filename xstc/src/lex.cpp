...
void XSTC::LexMARKDOWN()
{
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_DEFAULT), XS_default);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_LINE_BEGIN), XS_number);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_STRONG1), XS_key2);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_STRONG2), XS_key2);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_EM1), XS_key1);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_EM2), XS_key1);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER1), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER2), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER3), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER4), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER5), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HEADER6), XS_global);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_PRECHAR), XS_char);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_ULIST_ITEM), XS_s_string);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_OLIST_ITEM), XS_s_string);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_BLOCKQUOTE), XS_d_string);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_STRIKEOUT), XS_key3);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_HRULE), XS_number);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_LINK), XS_tag);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_CODE), XS_comment);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_CODE2), XS_comment2);
	this->StyleSetSpec(XSTC_DEF(MARKDOWN_CODEBK), XS_comment3);
	this->SetStyleBits(GetStyleBitsNeeded());
...
void XSTC::LexTXT2TAGS()
{
	...
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_LINE_BEGIN), XS_number);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_STRONG1), XS_key2);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_STRONG2), XS_key2);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_EM1), XS_key1);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_EM2), XS_key1);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER1), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER2), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER3), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER4), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER5), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HEADER6), XS_global);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_PRECHAR), XS_char);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_ULIST_ITEM), XS_s_string);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_OLIST_ITEM), XS_s_string);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_BLOCKQUOTE), XS_d_string);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_STRIKEOUT), XS_key3);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_HRULE), XS_number);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_LINK), XS_tag);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_CODE), XS_comment);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_CODE2), XS_comment2);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_CODEBK), XS_comment3);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_COMMENT), XS_comment);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_OPTION), XS_user);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_PREPROC), XS_preproc);
	this->StyleSetSpec(XSTC_DEF(TXT2TAGS_POSTPROC), XS_preproc);
	this->SetStyleBits(GetStyleBitsNeeded());
