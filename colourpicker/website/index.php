...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2006-06-26 20:16:09 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxColourPickerNAME";
      $subdir = "wxColourPickerSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxColourPicker running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxColourPickerSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxColourPickerSUBDIR/">here</a>.</p>
