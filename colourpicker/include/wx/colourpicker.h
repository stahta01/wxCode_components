...
/**
 * wxColourPicker class. This class provides a widgets which allows
 ...
 */
class WXDLLEXPORT wxColourPicker : public wxBitmapButton{
    wxColourPanel *m_cp;
    wxColour m_colour;
...
public:
     ...
     */
    wxColourPicker(wxWindow *parent, int id);
    ...
    // Events
    void OnPopup(wxCommandEvent& WXUNUSED(e));
 ...
 */
class WXDLLEXPORT wxColourPickerEvent : public wxCommandEvent {
    wxColour m_colour;
public:
    wxColourPickerEvent(int id, wxColour& colur);
