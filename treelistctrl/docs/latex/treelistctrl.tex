...
%% Modified by:
%% Created:     25.4.2004
%% RCS-ID:      $Id: treelistctrl.tex,v 1.11 2004-11-09 21:59:49 wyo Exp $
%% Copyright:   (c) wxCode
...
\constfunc{long}{GetChildrenCount}{\param{const wxTreeItemId\&}{ item}, \param{bool}{ recursively = TRUE}}
...
\constfunc{long}{GetSelections}{\param{wxArrayTreeItemIds\& }{selection}}
...
\func{wxTreeItemId}{InsertItem}{\param{const wxTreeItemId\& }{parent}, \param{long}{ before}, \param{const wxString\&}{ text},
 \param{int}{ image = -1}, \param{int}{ selImage = -1}, \param{wxTreeItemData*}{ data = NULL}}
...
\func{void}{AddColumn}{\param{const wxString\&}{ text}, \param{int}{ width}, \param{wxTreeListColumnAlign}{ alignment = wxTL_ALIGN_LEFT}}
...
\constfunc{wxTreeListColumnAlign}{GetColumnAlignment}{\param{int}{ column}}
...
\func{void}{SetColumnAlignment}{\param{int}{ column}, \param{const wxTreeListColumnAlign}{ align}}
...
\func{void}{ShowColumn}{\param{int}{ column}, \param{bool}{ shown}}
