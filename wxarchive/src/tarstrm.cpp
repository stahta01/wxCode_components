...
// RCS-ID:      $Id: tarstrm.cpp,v 1.1 2004-11-27 23:44:12 chiclero Exp $
// Copyright:   (c) 2004 Mike Wetherell
// Licence:     wxWindows licence
/////////////////////////////////////////////////////////////////////////////

#if defined(__GNUG__) && !defined(NO_GCC_PRAGMA)
#pragma implementation "tarstrm.h"
#endif
...
#if wxUSE_STREAMS && wxUSE_DATETIME // && wxUSE_TARSTREAM
...
wxDECLARE_SCOPED_PTR(wxTarEntry, _wxTarEntryPtr)
wxDEFINE_SCOPED_PTR (wxTarEntry, _wxTarEntryPtr)
...
{
    m_lasterror = stream.GetLastError();
}
...
wxTarEntry *wxTarInputStream::GetNextEntry()
{
    ...
    _wxTarEntryPtr entry(new wxTarEntry);
...
#endif // wxUSE_STREAMS && wxUSE_DATETIME && wxUSE_TARSTREAM
