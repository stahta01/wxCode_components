...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2007-01-10 21:15:13 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxMemoryMappedFileNAME";
      $subdir = "wxMemoryMappedFileSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxMemoryMappedFile running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxMemoryMappedFileSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxMemoryMappedFileSUBDIR/">here</a>.</p>
