...
void wxFixWidthImportCtrl::AdjustScrollbars()
{
    ...
    //Horizontal
    if ( m_scrbarV )
        thumbSize = (int) (m_scrbarV->GetPosition().x - 4 * m_margin) / dc.GetCharWidth();
