/////////////////////////////////////////////////////////////////////////////
// Name:        spellword.cpp
// Purpose:     Speaks ASCII characters.
// Author:      Alistair Conkie
// Modified by:
// Created:
// RCS-ID:      $Id: spellword.cpp,v 1.1.1.1 2003-12-28 21:08:13 wyo Exp $
...
void tsFreePhoneImplementation::say_ascii(int character)
	{
	outstring(Ascii[character&0x7F]);
	}

void tsFreePhoneImplementation::spell_word(char* word)
	{
