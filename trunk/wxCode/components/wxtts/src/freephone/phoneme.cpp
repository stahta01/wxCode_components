/////////////////////////////////////////////////////////////////////////////
// Name:        phoneme.cpp
// Purpose:     English to Phoneme translation.
// Author:      Alistair Conkie
// Modified by:
// Created:
// RCS-ID:      $Id: phoneme.cpp,v 1.1.1.1 2003-12-28 21:08:12 wyo Exp $
...
int tsFreePhoneImplementation::isvowel(char chr)
	{
	return (chr == 'A' || chr == 'E' || chr == 'I' || 
		chr == 'O' || chr == 'U');
	}

int tsFreePhoneImplementation::isconsonant(char chr)
	{
	return (isupper(chr) && !isvowel(chr));
	}

void tsFreePhoneImplementation::xlate_word(char word[])
	{
...
int tsFreePhoneImplementation::find_rule(char word[], int index, Rule* rules)
	{
	Rule *rule;
...
int tsFreePhoneImplementation::leftmatch(char* pattern, char* context)
...
int tsFreePhoneImplementation::rightmatch(char* pattern, char* context)
/*	pattern;	first char of pattern to match in text */
/*	context;	last char of text to be matched */
	{
	char *pat;
