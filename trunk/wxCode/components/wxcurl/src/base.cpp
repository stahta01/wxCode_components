...
/*
bool wxCurlBase::SetStringOpt(CURLoption option, const wxString &str)
{
    ...
    *
    ...
    wxCharBuffer buf = wxCURL_STRING2BUF(str);
    return SetOpt(option, (const char*)buf);
}*/
