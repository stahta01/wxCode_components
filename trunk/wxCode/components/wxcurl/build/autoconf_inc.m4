dnl ### begin block 00_header[wxcurl.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[wxcurl.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[wxcurl.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_OS2_1[wxcurl.bkl] ###
    COND_PLATFORM_OS2_1="#"
...
dnl ### begin block 20_COND_WINDOWS_IMPLIB_1[wxcurl.bkl] ###
    COND_WINDOWS_IMPLIB_1="#"
    if test "x$WINDOWS_IMPLIB" = "x1" ; then
        COND_WINDOWS_IMPLIB_1=""
    fi
    AC_SUBST(COND_WINDOWS_IMPLIB_1)
dnl ### begin block 20_COND_WX_DEBUG_0[wxcurl.bkl] ###
    COND_WX_DEBUG_0="#"
...
dnl ### begin block 20_COND_WX_DEBUG_1[wxcurl.bkl] ###
    COND_WX_DEBUG_1="#"
...
dnl ### begin block 20_COND_WX_SHARED_0[wxcurl.bkl] ###
    COND_WX_SHARED_0="#"
    if test "x$WX_SHARED" = "x0" ; then
        COND_WX_SHARED_0=""
    fi
    AC_SUBST(COND_WX_SHARED_0)
dnl ### begin block 20_COND_WX_SHARED_1[wxcurl.bkl] ###
    COND_WX_SHARED_1="#"
