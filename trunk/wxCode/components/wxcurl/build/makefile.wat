...
make_lib_dir_wxcurl_lib :  
	if not exist ..\lib\wat_$(____wxcurl_5) mkdir ..\lib\wat_$(____wxcurl_5)

!ifeq WX_SHARED 1
..\lib\wat_$(____wxcurl_5)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxcurl.dll :  make_lib_dir_wxcurl_dll  $(WXCURL_DLL_OBJECTS)
