dnl ### begin block 00_header[wxxml2.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[wxxml2.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[wxxml2.bkl] ###
    COND_DEPS_TRACKING_1="#"
    if test "x$DEPS_TRACKING" = "x1" ; then
        COND_DEPS_TRACKING_1=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_1)
dnl ### begin block 20_COND_PLATFORM_MACOSX_0_USE_SOVERCYGWIN_0_USE_SOVERSION_1[wxxml2.bkl] ###
...
dnl ### begin block 20_COND_USE_SOVERCYGWIN_1_USE_SOVERSION_1[wxxml2.bkl] ###
