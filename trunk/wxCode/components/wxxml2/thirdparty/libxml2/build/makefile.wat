...
LIBXML2_LIB_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
...
LIBXML2_DLL_CFLAGS = -bd $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTAUTOMATA_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTC14N_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTHTML_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTREADER_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTREGEXP_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTRELAX_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTSAX_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTSCHEMAS_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTURI_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
TESTXPATH_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
XMLLINT_CFLAGS = $(__UNICODE_DEFINE_p) $(__OPTIMIZEFLAG) $(__DEBUGINFO) &
	-i=..\include -i=$(ICONV_DIR)\include $(__REENTRANT_DEF_p) &
	$(__WIN32_THREADS_DEF_p) $(__CTLS_THREADS_DEF_p) $(__PTHREADS_DEF_p) &
	$(__ZLIB_DEF_p) $(__DEBUG_DEF_p) $(__STATIC_DEF_p) -dWIN32 -d_WINDOWS -d_MBCS &
	$(CPPFLAGS) $(CFLAGS)
...
..\lib\libxml2.dll :  $(LIBXML2_DLL_OBJECTS) ..\config.h ..\lib
	...
	@%append watcom\libxml2_dll.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib $(LDFLAGS)
...
..\bin\testAutomata.exe :  $(TESTAUTOMATA_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testAutomata.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testAutomata.lbc option stack=%i
...
..\bin\testC14N.exe :  $(TESTC14N_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testC14N.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testC14N.lbc option stack=%i
...
..\bin\testHTML.exe :  $(TESTHTML_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testHTML.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testHTML.lbc option stack=%i
...
..\bin\testReader.exe :  $(TESTREADER_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testReader.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testReader.lbc option stack=%i
...
..\bin\testRegexp.exe :  $(TESTREGEXP_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testRegexp.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testRegexp.lbc option stack=%i
...
..\bin\testRelax.exe :  $(TESTRELAX_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testRelax.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testRelax.lbc option stack=%i
...
..\bin\testSax.exe :  $(TESTSAX_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testSax.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testSax.lbc option stack=%i
...
..\bin\testSchemas.exe :  $(TESTSCHEMAS_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testSchemas.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testSchemas.lbc option stack=%i
...
..\bin\testURI.exe :  $(TESTURI_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testURI.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testURI.lbc option stack=%i
...
..\bin\testXPath.exe :  $(TESTXPATH_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\testXPath.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\testXPath.lbc option stack=%i
...
..\bin\xmllint.exe :  $(XMLLINT_OBJECTS) $(__libxml2_lib___depname)
	...
	@%append watcom\xmllint.lbc   $(__DEBUGINFO_15) libpath $(ICONV_DIR)\lib system nt ref 'main_' $(LDFLAGS)
	...
	@for %i in () do @%append watcom\xmllint.lbc option stack=%i
