...
// $Source: /home/ulrich/cvs-wxcode/wxCode/components/treemultictrl/contrib/samples/treemultictrl/MultiCtrlTest.cpp,v $
// $Revision: 1.1 $
// $Date: 2005-08-05 19:17:25 $
//---------------------------------------------------------------------------
// Author:      Jorgen Bodde
       ...
       : wxFrame(NULL, -1, title, pos, size, style)
{
	...
	sizer->Add(new wxRadioButton( pnl, ID_RADIO5, _T("Collapse all")), 0, wxALL, 2 );
	sizer->Add(new wxRadioButton( pnl, ID_RADIO6, _T("Expand all")), 0, wxALL, 2 );
	...
	_tmc->AppendWindow(item, new wxTextCtrl(_tmc, ID_SETTEXT, _T(""), wxDefaultPosition, wxSize(50,-1)), _T(""), wndinfo);
