...
premake/premake-mac --target cl-gcc --wx-version $release $unicode $debug $wxroot $shared $wxshared
echo done...
echo 
#
# ========== GNU Makefile ==========
premake/premake-mac --target gnu --wx-version $release unicode $debug $wxroot $shared $wxshared
echo done...
echo 
#
