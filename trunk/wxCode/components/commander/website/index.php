...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2007-01-26 08:56:16 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxCommanderNAME";
      $subdir = "wxCommanderSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxCommander running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxCommanderSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxCommanderSUBDIR/">here</a>.</p>
