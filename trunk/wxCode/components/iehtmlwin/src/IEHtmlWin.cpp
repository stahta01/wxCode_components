...
c	FS_IOleControlSite * m_IOleControlSite;
...
{
	//wxString log;
	//log.Printf("url progress: %li/%li", current, maximum);
...
{
	wxLogTrace("IOleWindow::GetWindow");
...
{
	wxLogTrace("IOleWindow::ContextSensitiveHelp");
	return S_OK;
}
...
{
	wxLogTrace("IOleInPlaceUIWindow::GetBorder");
...
{
	wxLogTrace("IOleInPlaceUIWindow::RequestBorderSpace");
...
{
	wxLogTrace("IOleInPlaceFrame::EnableModeless");
	return S_OK;
}

HRESULT FS_IOleInPlaceFrame::TranslateAccelerator(LPMSG lpmsg, WORD wID)
{
	wxLogTrace("IOleInPlaceFrame::TranslateAccelerator");
...
{
	wxLogTrace("IOleInPlaceSite::CanInPlaceActivate");
	return S_OK;
}

HRESULT FS_IOleInPlaceSiteWindowless::OnInPlaceActivate()
{
	wxLogTrace("IOleInPlaceSite::OnInPlaceActivate");
...
{
	wxLogTrace("IOleInPlaceSite::OnUIActivate");
...
{
	wxLogTrace("IOleInPlaceSite::GetWindowContext");
...
{
	wxLogTrace("IOleInPlaceSite::Scroll");
	return S_OK;
}

HRESULT FS_IOleInPlaceSiteWindowless::OnUIDeactivate(BOOL fUndoable)
{
	wxLogTrace("IOleInPlaceSite::OnUIDeactivate");
...
{
	wxLogTrace("IOleInPlaceSite::OnInPlaceDeactivate");
...
{
	wxLogTrace("IOleInPlaceSite::DiscardUndoState");
	return S_OK;
}

HRESULT FS_IOleInPlaceSiteWindowless::DeactivateAndUndo()
{
	wxLogTrace("IOleInPlaceSite::DeactivateAndUndo");
	return S_OK;
}

HRESULT FS_IOleInPlaceSiteWindowless::OnPosRectChange(LPCRECT lprcPosRect)
{
	wxLogTrace("IOleInPlaceSite::OnPosRectChange");
	return S_OK;
}
...
{
	wxLogTrace("IOleInPlaceSiteEx::OnInPlaceActivateEx");
...
{
	wxLogTrace("IOleInPlaceSiteEx::OnInPlaceDeactivateEx");
	return S_OK;
}

HRESULT FS_IOleInPlaceSiteWindowless::RequestUIActivate()
{
	wxLogTrace("IOleInPlaceSiteEx::RequestUIActivate");
	return S_FALSE;
}
...
{
	wxLogTrace("IOleInPlaceSiteWindowless::ReleaseDC");
	return E_NOTIMPL;
}

HRESULT FS_IOleInPlaceSiteWindowless::InvalidateRect(LPCRECT pRect, BOOL fErase)
{
	wxLogTrace("IOleInPlaceSiteWindowless::InvalidateRect");
...
{
	wxLogTrace("IOleClientSite::SaveObject");
	return S_OK;
}
...
HRESULT FS_IOleClientSite::GetMoniker(DWORD dwAssign, DWORD dwWhichMoniker,
							  IMoniker ** ppmk)
{
	wxLogTrace("IOleClientSite::GetMoniker");
	return E_NOTIMPL;
}

HRESULT FS_IOleClientSite::GetContainer(LPOLECONTAINER * ppContainer)
{
	wxLogTrace("IOleClientSite::GetContainer");
...
{
	wxLogTrace("IOleClientSite::ShowObject");
	return S_OK;
}

HRESULT FS_IOleClientSite::OnShowWindow(BOOL fShow)
{
	wxLogTrace("IOleClientSite::OnShowWindow");
	return S_OK;
}

HRESULT FS_IOleClientSite::RequestNewObjectLayout()
{
	wxLogTrace("IOleClientSite::RequestNewObjectLayout");
	return E_NOTIMPL;
}
...
{
	wxLogTrace("IParseDisplayName::ParseDisplayName");
	return E_NOTIMPL;
}
...
{
	wxLogTrace("IOleContainer::EnumObjects");
	return E_NOTIMPL;
}

HRESULT FS_IOleItemContainer::LockContainer(BOOL fLock)
{
	wxLogTrace("IOleContainer::LockContainer");
	// TODO
	return S_OK;
}
...
{
	wxLogTrace("IOleItemContainer::GetObject");
...
{
	wxLogTrace("IOleItemContainer::GetObjectStorage");
	if (pszItem == NULL) return E_INVALIDARG;
...
{
	wxLogTrace("IOleItemContainer::IsRunning");
	if (pszItem == NULL) return E_INVALIDARG;
...
{
	wxLogTrace("IOleControlSite::OnControlInfoChanged");
	return S_OK;
}

HRESULT FS_IOleControlSite::LockInPlaceActive(BOOL fLock)
{
	wxLogTrace("IOleControlSite::LockInPlaceActive");
...
{
	wxLogTrace("IOleControlSite::TranslateAccelerator");
	// TODO: send an event with this id
	return E_NOTIMPL;
}
...
{
	wxLogTrace("IOleControlSite::OnFocus");
	return S_OK;
}

HRESULT FS_IOleControlSite::ShowPropertyFrame()
{
	wxLogTrace("IOleControlSite::ShowPropertyFrame");
	return E_NOTIMPL;
}
...
{
	wxLogTrace("IOleCommandTarget::QueryStatus");
...
HRESULT FS_IOleCommandTarget::Exec(const GUID * pguidCmdGroup, DWORD nCmdID, 
						...
						VARIANTARG * pVaOut)
{
	wxLogTrace("IOleCommandTarget::Exec");
	bool bCmdGroupFound = false;
...
{
	wxLogTrace("IAdviseSink2::OnLinkSrcChange");
}
...
{
	wxLogTrace("IAdviseSinkEx::OnViewStatusChange");
}
