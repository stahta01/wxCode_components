...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2006-07-18 13:50:46 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxCoolBarNAME";
      $subdir = "wxCoolBarSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxCoolBar running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxCoolBarSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxCoolBarSUBDIR/">here</a>.</p>
