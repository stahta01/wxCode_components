 ...
 Website: http://wxcode.sourceforge.net/components/filterctrl
 Author: Moskvichev Andrey V.
 Version: 1.0 
 Description:
 wxFilterCtrl is filter control, like in MS Office 2007. 
 It allows filtering by values, data ranges, and various conditions.
 ...
 1.0 - first version of wxFilterCtrl at wxCode
 
 
 [optionally: Known bugs, Author's info, ... ]
 Contact author: 
   email: mab[at]smtp[dot].ru
   skype: mab_at_stmp_ru
