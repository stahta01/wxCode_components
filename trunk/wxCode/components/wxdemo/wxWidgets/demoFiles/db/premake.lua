...
if ( windows ) then
	table.insert(package.files, "dbtest.rc" )
end
...
--******* WINDOWS SETUP ***********
	...
	if ( options["unicode"] ) then
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver.."u", "odbc32" } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."ud", "odbc32" } )
	else
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver, "odbc32" } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."d", "odbc32" } )
	end
