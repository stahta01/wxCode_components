...
--******* WINDOWS SETUP ***********
	...
	if ( options["unicode"] ) then
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver.."u", "wxmsw28u_gl", "opengl32", "glu32" } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."ud", "wxmsw28ud_gl", "opengl32", "glu32" } )
	else
		table.insert( package.config["Release"].links, { "wxmsw"..wx_ver, "wxmsw28_gl", "opengl32", "glu32"  } )
		table.insert( package.config["Debug"].links, { "wxmsw"..wx_ver.."d", "wxmsw28d_gl", "opengl32", "glu32" } )
	end
