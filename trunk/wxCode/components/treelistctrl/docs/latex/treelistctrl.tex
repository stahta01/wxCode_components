...
%% Modified by:
%% Created:     25.4.2004
%% RCS-ID:      $Id: treelistctrl.tex,v 1.7 2004-09-30 19:30:30 wyo Exp $
%% Copyright:   (c) wxCode
...
\twocolwidtha{5cm}
\begin{twocollist}\itemsep=0pt
\twocolitem{wxTL\_SEARCH\_LEVEL}{Searches within only the current level.}
\twocolitem{wxTL\_SEARCH\_VISIBLE}{Searches within all visible items.}
\twocolitem{wxTL\_SEARCH\_FULL}{Searches within the full tree.}
\twocolitem{wxTL\_SEARCH\_PARTIAL}{Matches only partial up to the submitted text length.}
\twocolitem{wxTL\_SEARCH\_NOCASE}{Matches case insensitive.}
\end{twocollist}
