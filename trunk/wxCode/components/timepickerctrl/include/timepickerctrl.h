...
This control is still in an alpha stage of development.  Although there are no known bugs yet, it is not well tested.  The control was developed on 32-bit i386 Ubuntu 10.04 LTS Desktop version using wxWidgets 2.8.11.  I would appreciate any feedback on experiences with this control on other platforms, or any suggestions for improvement, etc.  If you do email me, please include the string "timepickerctrl" in the subject line so I can filter the message to the appropriate folder.  I can't promise I'll provide fixes or implement suggestions or even respond to email messages, but I'll try to be as responsive as I can with the time I have available, and it can't hurt to ask.
