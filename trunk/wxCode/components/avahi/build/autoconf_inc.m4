dnl ### begin block 00_header[wxavahi.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[wxavahi.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[wxavahi.bkl] ###
    COND_DEPS_TRACKING_1="#"
    if test "x$DEPS_TRACKING" = "x1" ; then
        COND_DEPS_TRACKING_1=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_1)
dnl ### begin block 20_COND_PLATFORM_MACOSX_0_USE_SOVERCYGWIN_0_USE_SOVERSION_1[wxavahi.bkl] ###
...
dnl ### begin block 20_COND_USE_SOVERCYGWIN_1_USE_SOVERSION_1[wxavahi.bkl] ###
