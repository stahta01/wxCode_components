...
!ifeq WX_SHARED 0
__webupdate_lib___depname = &
	..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.lib
!endif
__webupdate_dll___depname =
!ifeq WX_SHARED 1
__webupdate_dll___depname = &
	..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.dll
!endif
____webupdate_3 =
!ifeq WX_SHARED 0
____webupdate_3 = lib
...
WEBUPDATE_DLL_CXXFLAGS = -bd $(____WX_SHARED) $(__WXUNICODE_DEFINE_p) &
	$(__WXDEBUG_DEFINE_p) -d__WXMSW__ &
	-i=$(WX_DIR)$(WXLIBPATH)\msw$(WXLIBPOSTFIX) -i=$(WX_DIR)\include $(VAR) &
	-i=..\include -dWXMAKINGDLL_WEBUPDATE -i=$(HTTPENGINE_DIR)\include &
...
SIMPLE_1_0_0_CXXFLAGS = $(____WX_SHARED) $(__WXUNICODE_DEFINE_p) &
	...
	$(VAR) -i=..\include $(CPPFLAGS) $(CXXFLAGS)
...
!ifeq WX_SHARED 0
..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.lib :  make_lib_dir_webupdate_lib  $(WEBUPDATE_LIB_OBJECTS)
...
make_lib_dir_webupdate_lib :  
	if not exist ..\lib\wat_$(____webupdate_3) mkdir ..\lib\wat_$(____webupdate_3)

!ifeq WX_SHARED 1
..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.dll :  make_lib_dir_webupdate_dll  $(WEBUPDATE_DLL_OBJECTS)
	...
	wlib -q -n -b ..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.lib +$^@
!endif
...
..\src\webupdater.exe :  $(WEBUPDATER_OBJECTS) watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\webupdater_app.res $(__webupdate_lib___depname)
	...
	@%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\webupdater.lbc $(LDFLAGS) libpath $(WX_DIR)$(WXLIBPATH) $(VAR_5) libpath ..$(WXLIBPATH) libpath $(HTTPENGINE_DIR)\lib system nt_win ref '_WinMain@16'
	@for %i in ($(WEBUPDATER_OBJECTS)) do @%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\webupdater.lbc file %i
	@for %i in ( ..\lib\wat_$(____webupdate_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_webupdate.lib $(__HTTPENGINEDEP_LIB_p) $(__WXLIB_ADV_NAME_p) $(__WXLIB_HTML_NAME_p) $(__WXLIB_ADV_NAME_p) $(__WXLIB_XRC_NAME_p) $(__WXLIB_XML_NAME_p) $(__WXLIB_NET_NAME_p) $(__WXLIB_CORE_NAME_p) $(__WXLIB_BASE_NAME_p) wxtiff$(WX3RDPARTYLIBPOSTFIX).lib wxjpeg$(WX3RDPARTYLIBPOSTFIX).lib wxpng$(WX3RDPARTYLIBPOSTFIX).lib wxzlib$(WX3RDPARTYLIBPOSTFIX).lib wxregex$(WXLIBPOSTFIX).lib wxexpat$(WX3RDPARTYLIBPOSTFIX).lib kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\webupdater.lbc library %i
...
..\samples\simple\v1.0.0\simple.exe :  $(SIMPLE_1_0_0_OBJECTS) ..\src\webupdater.exe make_sample_dir_simple_1_0_0
	...
	@%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\simple_1_0_0.lbc $(LDFLAGS) libpath $(WX_DIR)$(WXLIBPATH) $(VAR_5) libpath ..$(WXLIBPATH) system nt_win ref '_WinMain@16'
...
..\samples\simple\v2.0.3\simple.exe :  $(SIMPLE_2_0_3_OBJECTS) ..\src\webupdater.exe make_sample_dir_simple_2_0_3
	...
	@%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\simple_2_0_3.lbc $(LDFLAGS) libpath $(WX_DIR)$(WXLIBPATH) $(VAR_5) libpath ..$(WXLIBPATH) system nt_win ref '_WinMain@16'
...
..\samples\advanced\v0.0.1\advanced.exe :  $(ADVANCED_0_0_1_OBJECTS) ..\src\webupdater.exe make_sample_dir_advanced_0_0_1
	...
	@%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\advanced_0_0_1.lbc $(LDFLAGS) libpath $(WX_DIR)$(WXLIBPATH) $(VAR_5) libpath ..$(WXLIBPATH) system nt_win ref '_WinMain@16'
...
..\samples\advanced\v1.5.0\advanced.exe :  $(ADVANCED_1_5_0_OBJECTS) ..\src\webupdater.exe make_sample_dir_advanced_1_5_0
	...
	@%append watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\advanced_1_5_0.lbc $(LDFLAGS) libpath $(WX_DIR)$(WXLIBPATH) $(VAR_5) libpath ..$(WXLIBPATH) system nt_win ref '_WinMain@16'
