dnl ### begin block 00_header[webupdate.bkl] ###
dnl
...
dnl ### begin block 20_COND_DEPS_TRACKING_0[webupdate.bkl] ###
    COND_DEPS_TRACKING_0="#"
    if test "x$DEPS_TRACKING" = "x0" ; then
        COND_DEPS_TRACKING_0=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_0)
dnl ### begin block 20_COND_DEPS_TRACKING_1[webupdate.bkl] ###
    COND_DEPS_TRACKING_1="#"
    if test "x$DEPS_TRACKING" = "x1" ; then
        COND_DEPS_TRACKING_1=""
    fi
    AC_SUBST(COND_DEPS_TRACKING_1)
dnl ### begin block 20_COND_PLATFORM_MACOSX_0_USE_SOVERCYGWIN_0_USE_SOVERSION_1[webupdate.bkl] ###
...
dnl ### begin block 20_COND_PLATFORM_MAC_0[webupdate.bkl] ###
    COND_PLATFORM_MAC_0="#"
    if test "x$PLATFORM_MAC" = "x0" ; then
        COND_PLATFORM_MAC_0=""
    fi
    AC_SUBST(COND_PLATFORM_MAC_0)
dnl ### begin block 20_COND_PLATFORM_MAC_1[webupdate.bkl] ###
    COND_PLATFORM_MAC_1="#"
    if test "x$PLATFORM_MAC" = "x1" ; then
        COND_PLATFORM_MAC_1=""
    fi
    AC_SUBST(COND_PLATFORM_MAC_1)
dnl ### begin block 20_COND_PLATFORM_OS2_1[webupdate.bkl] ###
    COND_PLATFORM_OS2_1="#"
...
dnl ### begin block 20_COND_SHARED_1[webupdate.bkl] ###
    COND_SHARED_1="#"
    if test "x$SHARED" = "x1" ; then
        COND_SHARED_1=""
    fi
    AC_SUBST(COND_SHARED_1)
dnl ### begin block 20_COND_USE_CURL_0[webupdate.bkl] ###
    COND_USE_CURL_0="#"
    if test "x$USE_CURL" = "x0" ; then
        COND_USE_CURL_0=""
    fi
    AC_SUBST(COND_USE_CURL_0)
dnl ### begin block 20_COND_USE_CURL_1[webupdate.bkl] ###
    COND_USE_CURL_1="#"
    if test "x$USE_CURL" = "x1" ; then
        COND_USE_CURL_1=""
    fi
    AC_SUBST(COND_USE_CURL_1)
...
dnl ### begin block 20_COND_USE_SOVERCYGWIN_1_USE_SOVERSION_1[webupdate.bkl] ###
