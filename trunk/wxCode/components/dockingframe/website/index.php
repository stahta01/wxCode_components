...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2006-07-16 13:29:08 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxDockingFrameNAME";
      $subdir = "wxDockingFrameSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxDockingFrame running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxDockingFrameSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxDockingFrameSUBDIR/">here</a>.</p>
