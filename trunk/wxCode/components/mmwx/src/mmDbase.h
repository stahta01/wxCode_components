...
class mmDbase
{
  public:
   ...
   ~mmDbase();
    ...
    bool Init(wxString dsn      = wxString(""),
              wxString user     = wxString(""),
              wxString password = wxString(""),
              wxString dbaseDir = wxString(""));
...
// Temporary solution for Updateing an Interbase database
extern bool UpdateDbase(mmDbase* db, mmDbaseTable* tab,
