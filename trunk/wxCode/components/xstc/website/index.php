...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2006/07/18 14:06:42 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "XSTC running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/XSTCSUBDIR
...
'); ?>
  ...
  <a href="../../docs/XSTCSUBDIR/">here</a>.</p>
