...
#else
	TestCout( _T("The test is only meaningfull in ANSI builds\n" ));
#endif
	return r;
}
...
#else
	TestCout( _T("The test is only meaningfull in Unicode builds\n" ));
#endif
	return r;
}
...
// Unicode mode: writes to a stream in UTF-8 a value - it seems a duplicate of Test8_2()
...
// this is much like Test8_3() which failed:
