...
<?php
  ...
  // RCS-ID: $Id: index.php,v 1.1 2006-05-14 09:06:59 frm Exp $
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-AU">
	<?php
      $compname = "wxDragSpinCtrlNAME";
      $subdir = "wxDragSpinCtrlSUBDIR";
  ...
  -->
	...
	<!-- NOTE on SCREENSHOTS:
       ...
       <?php writeScreenshotLink("myshot.png", "wxDragSpinCtrl running with wxMSW 2.5.3"); ?>

	     where the 'myshot.png' file is a file that you have uploaded in
          /home/groups/w/wx/wxcode/htdocs/screenshots/wxDragSpinCtrlSUBDIR
...
'); ?>
  ...
  <a href="../../docs/wxDragSpinCtrlSUBDIR/">here</a>.</p>
