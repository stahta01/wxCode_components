 ...
 stringformatter ReadMe
 -------------
 
 Website: http://wxcode.sourceforge.net/components/stringformatter
 Author: Nathan Shaffer
 Version: 1.0 
 Description:
 A library to provide custom formatting of strings using farmatting characters.
 ...
 1.0 - first version of stringformatter at wxCode
